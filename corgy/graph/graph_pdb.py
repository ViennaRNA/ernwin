...
def get_twists_core(chain, start1, start2, end1, end2,
                    mids=None, method=cbc.Configuration.mids_method):
    '''
    ...
    if mids is None:
        mids = get_mids(chain, [start1, end1, end2, start2],
                        method=cbc.Configuration.mids_method)
...
def add_stem_information_from_pdb_chain(bg, chain):
    '''
...
def bg_rmsd(bg1, bg2):
    ...
    return cbr.centered_rmsd(centers1, centers2)
