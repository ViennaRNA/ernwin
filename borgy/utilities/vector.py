...
def time_cob():
    t1 = timeit.Timer("time_cob1()", "from borgy.utilities.vector import time_cob1")
    t2 = timeit.Timer("time_cob2()", "from borgy.utilities.vector import time_cob2")
...
def time_basis1():
    t1 = timeit.Timer("change_basis1_benchmark()","from borgy.utilities.vector import change_basis1_benchmark")
    print t1.repeat(number=10000)

def time_basis2():
    t2 = timeit.Timer("change_basis2_benchmark()","from borgy.utilities.vector import change_basis2_benchmark")
    print t2.repeat(number=10000)
...
def time_mag():
    t1 = timeit.Timer("time_mag1()", "from borgy.utilities.vector import time_mag1")
    t2 = timeit.Timer("time_mag2()", "from borgy.utilities.vector import time_mag2")
